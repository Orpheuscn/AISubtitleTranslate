...
3. **上下文字幕处理（非常重要）：**
   ...
   **重要示例（理解句子延续）：**
   ...
   翻译 [98] 时，要理解这是 [96] 的延续（都是"我想告诉你们..."），而不是一个独立的新句子。
...
**重要提醒：**
- 标记为 [CONTEXT] 的字幕是**前后文语境**，必须仔细阅读以理解句子的完整含义
- [CONTEXT] 字幕**不需要翻译**，但要用来确保翻译的连贯性
- **如果需要翻译的字幕是前面句子的延续，翻译时要体现出这种延续关系**
...
**请严格按照格式返回翻译，确保 ${batch.length} 个序号都有对应的翻译，一个都不能少。**`
          console.log(`\n📤 发送请求到 DeepSeek API...`)
          console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`)
